...
Source:
https://github.com/CSAILVision/semantic-segmentation-pytorch/blob/master/models/models.pys
"""

from lib.models.deeplab.sync_batchnorm import SynchronizedBatchNorm2d
import math
import os
import sys
import torch
...
def conv_1x1_bn(inp, oup):
    return nn.Sequential(
        nn.Conv2d(inp, oup, 1, 1, 0, bias=False), SynchronizedBatchNorm2d(oup),
...
class ModelBuilder():
    ...
    def build_encoder(self, arch='resnet50dilated', fc_dim=512, weights=''):
        ...
        if arch == 'mobilenetv2dilated':
            orig_mobilenet = mobilenetv2(pretrained=pretrained)
